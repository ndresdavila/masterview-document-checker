...
$destRoot = Join-Path $checker 'random-10f'

$used = New-Object System.Collections.Generic.HashSet[string]
Get-ChildItem -LiteralPath $checker -Recurse -Filter source.txt -ErrorAction SilentlyContinue |
  Where-Object { $_.FullName -match '\\(fixtures|random-15|random-10b|random-10c|random-10d|random-10e|public|test)\\' } |
  ForEach-Object {
...
@(
  ...
  '6466180070','ZIMUGYL805750','6463507860','6461432810','6462046680',
  'ZIMUGYL805400','ZIMUGYL805751','ZIMUGYL807048','ZIMUGYL805759','ZIMUGYL810474'
...
Write-Host "UNUSED LEFT:" $unused.Count
$pick = @($unused | Get-Random -Count ([Math]::Min(10, $unused.Count)))
